...
{
    //definindo as coleções de teste para a webapi e para web
    ...
    public class IntegrationTestsFixture<TStartup> : IDisposable where TStartup : class
    {
        ...
        public IntegrationTestsFixture()
        {
            ...
            //LojaAppFactory -> possui o método CreateClient que faz parte de WebApplicationFactoy e devolve uma
